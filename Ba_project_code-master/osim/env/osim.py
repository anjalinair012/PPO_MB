...
class RUGTFPEnv(OsimModel):
    ...
    def reset(self, project=True, seed=None, init_pose=None, obs_as_dict=False):
        ...
        QQ[0] = init_pose[0] # pelvis_tilt
        QQ[1] = init_pose[1] # pelvis_list
        QQ[2] = init_pose[2] # pelvis_rotation
        QQ[3] = init_pose[3] # pelvis_tx
        QQ[4] = init_pose[4] # pelvis_ty
        QQ[5] = init_pose[5] # pelvis_tz
        QQ[6] = init_pose[6] # hip_flexion_r
        QQ[7] = init_pose[7] # hip_adduction_r
        QQ[8] = init_pose[8] # hip_rotation_r
        QQ[9] = init_pose[9] # knee_angle_r
        QQ[10] = init_pose[10] # ankle_angle_r
        QQ[11] = init_pose[11] # hip_flexion_l
        QQ[12] = init_pose[12] # hip_adduction_l
        QQ[13] = init_pose[13] # hip_rotation_l
        QQ[14] = init_pose[14] # knee_angle_l
        QQ[15] = init_pose[15] # ankle_angle_l
        QQ[16] = init_pose[16] # lumbar_extension
        ...
        self.prev_observation_dic = self.get_observation_dict()
        if not project:
    ...
    def get_reward_1(self):  # For reward type 2  based on difficulty(2), normalize rewards
        state_desc = self.get_observation_dict()
